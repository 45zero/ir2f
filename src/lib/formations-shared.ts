...
export const GROUPE_EQUIVALENCE_LABELS: Record<GroupeEquivalence, string> = {
  ...
  PRO_BEF: "Parcours pro — BEF (titre)",
  PRO_BEF_TRAD: "Parcours pro — BEF traditionnel",
  PRO_BEF_APP: "Parcours pro — BEF apprentissage",
  PRO_BEF_VAE: "Parcours pro — BEF VAE",
  PRO_BMF: "Parcours pro — BMF (titre)",
  PRO_BMF_TRAD: "Parcours pro — BMF traditionnel",
